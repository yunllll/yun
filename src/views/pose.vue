<template>
  <button class="futuristic-button">基于yolov11的的俯卧撑监测平台</button>
  <div style="display: flex;  flex-direction: column; align-items: center; padding-top: 8vh;position: relative;">
    <div class="card" style="position: absolute;top: 80px;left: 80px;width: 300px;height: 300px;">
      <div class="image"><img src="../assets/AnKe.jpg" alt=""
          style="width: 298px;height: 298px;"></div>
      <span class="title" style="text-align: center;">今天也要继续锻炼，加油！</span>
    </div>
    ...
    <div class="container noselect" @click="resetData">
      ...
      <div id="shuttle-wrapper">
        ...
        <div id="shadow"></div>
        <svg viewBox="0 0 230.24 542.46" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"
          id="b">
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse"
              gradientTransform="translate(160.35 -471.85) rotate(-7.06) scale(1.56 1.68)" y2="549.77" x2="-104.11"
              y1="545.09" x1="-130.63" id="d">
            ...
            <linearGradient gradientUnits="userSpaceOnUse" y2="479.08" x2="113.37" y1="475.4" x1="70.56" id="e">
            ...
            <linearGradient gradientUnits="userSpaceOnUse" y2="270.33" x2="123.89" y1="269.31" x1="65.74" id="f">
              <stop stop-color="#e5e5e5" offset="0"></stop>
              <stop stop-color="#e3e3e3" offset=".63"></stop>
              <stop stop-color="#dcdcdc" offset=".85"></stop>
              <stop stop-color="#d3d2d3" offset="1"></stop>
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" y2="114.99" x2="112.45" y1="114.99" x1="70.84" id="g">
            ...
            <linearGradient xlink:href="#g" y2="142.07" x2="112.45" y1="142.07" x1="70.84" id="h"></linearGradient>
            <linearGradient xlink:href="#g" y2="178.73" x2="112.45" y1="178.73" x1="70.84" id="i"></linearGradient>
            <linearGradient xlink:href="#g" y2="254.03" x2="112.45" y1="254.03" x1="70.84" id="j"></linearGradient>
            <linearGradient xlink:href="#g" y2="329.25" x2="112.45" y1="329.25" x1="70.84" id="k"></linearGradient>
            <linearGradient xlink:href="#g" y2="386.88" x2="112.45" y1="386.88" x1="70.84" id="l"></linearGradient>
            <linearGradient xlink:href="#g" y2="407.2" x2="112.45" y1="407.2" x1="70.84" id="m"></linearGradient>
            <linearGradient xlink:href="#g" y2="414.79" x2="112.45" y1="414.79" x1="70.84" id="n"></linearGradient>
            <linearGradient xlink:href="#g" y2="423.88" x2="112.45" y1="423.88" x1="70.84" id="o"></linearGradient>
            <linearGradient xlink:href="#g" y2="435.68" x2="112.45" y1="435.68" x1="70.84" id="p"></linearGradient>
            <linearGradient xlink:href="#g" y2="446.33" x2="112.45" y1="446.33" x1="70.84" id="q"></linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" y2="280.59" x2="112.45" y1="280.59" x1="70.67" id="r">
              <stop stop-opacity="0" stop-color="#fff" offset="0"></stop>
            ...
            <linearGradient gradientUnits="userSpaceOnUse" y2="464.45" x2="120.43" y1="455.38" x1="63.17" id="s">
              <stop stop-opacity="0" stop-color="#fff" offset="0"></stop>
            ...
            <linearGradient xlink:href="#r" y2="91.43" x2="115.35" y1="87.78" x1="72.87" id="t"></linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" y2="217.5" x2="194.16" y1="217.5" x1="102.87" id="v">
              <stop stop-color="#d68029" offset="0"></stop>
              <stop stop-color="#b3511b" offset="1"></stop>
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" y2="404.51" x2="158.77" y1="23.53" x1="134.44" id="w">
            ...
            <radialGradient gradientUnits="userSpaceOnUse"
              gradientTransform="translate(119.12 192.29) rotate(-104.58) scale(1 .55)" r="134.05" fy="71.95" fx="60.36"
              cy="64.81" cx="122.52" id="y">
              <stop stop-opacity="0" stop-color="#dd884e" offset=".72"></stop>
              <stop stop-color="#ed9654" offset="1"></stop>
            </radialGradient>
            <radialGradient xlink:href="#y" gradientTransform="translate(176.37 200.83) rotate(-75.42) scale(1 -.55)"
              r="133.29" fy="72.72" fx="68.57" cy="65.62" cx="130.39" id="z"></radialGradient>
            <linearGradient gradientUnits="userSpaceOnUse" y2="217.56" x2="142.83" y1="438.65" x1="161.35" id="aa">
            ...
            <linearGradient gradientUnits="userSpaceOnUse"
              gradientTransform="translate(189.08 .72) rotate(.18) scale(1.34 1)" y2="285.84" x2="-7.1" y1="284.22"
              x1="-43.8" id="ab">
            ...
            <linearGradient xlink:href="#d" y2="591.23" x2="-38.94" y1="586.55" x1="-65.46" id="ac"></linearGradient>
            <linearGradient xlink:href="#e" y2="535.79" x2="222.95" y1="532.12" x1="180.14" id="ad"></linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" y2="327.04" x2="233.47" y1="326.03" x1="175.32" id="ae">
              <stop stop-color="#e5e5e5" offset="0"></stop>
            ...
            <linearGradient xlink:href="#g" y2="463.91" x2="222.03" y1="463.91" x1="180.42" id="af"></linearGradient>
            <linearGradient xlink:href="#g" y2="471.51" x2="222.03" y1="471.51" x1="180.42" id="ag"></linearGradient>
            <linearGradient xlink:href="#g" y2="480.59" x2="222.03" y1="480.59" x1="180.42" id="ah"></linearGradient>
            <linearGradient xlink:href="#g" y2="492.4" x2="222.03" y1="492.4" x1="180.42" id="ai"></linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" y2="385.97" x2="222.04" y1="385.97" x1="180.43" id="aj">
            ...
            <linearGradient xlink:href="#g" y2="503.1" x2="222.03" y1="503.1" x1="180.42" id="ap"></linearGradient>
            <linearGradient xlink:href="#r" y2="337.31" x2="222.03" y1="337.31" x1="180.25" id="aq"></linearGradient>
            <linearGradient xlink:href="#s" y2="521.17" x2="230.01" y1="512.1" x1="172.75" id="ar"></linearGradient>
            <linearGradient xlink:href="#r" y2="148.14" x2="224.93" y1="144.49" x1="182.45" id="as"></linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" y2="424" x2="68.43" y1="414.65" x1="33.58" id="at">
            ...
            <linearGradient xlink:href="#d" gradientTransform="matrix(1, 0, 0, 1, 0, 0)" y2="466.58" x2="111.3"
              y1="461.9" x1="84.78" id="au"></linearGradient>
            <linearGradient xlink:href="#d" gradientTransform="translate(108.68 -1.95) rotate(13.28)" y2="464.99"
              x2="78.06" y1="459.96" x1="49.55" id="av"></linearGradient>
            <linearGradient xlink:href="#d" gradientTransform="translate(37.21 -2.14) rotate(4.64)" y2="468.28"
              x2="84.28" y1="465.78" x1="70.1" id="aw"></linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" y2="317.69" x2="185.62" y1="317.69" x1="17.4" id="ax">
            ...
            <linearGradient gradientUnits="userSpaceOnUse" y2="307.1" x2="131.64" y1="302.93" x1="52.2" id="ba">
            ...
            <linearGradient gradientUnits="userSpaceOnUse" y2="427.46" x2="88.01" y1="180.46" x1="89.33" id="bb">
              <stop stop-color="#fff" offset="0"></stop>
            ...
            <linearGradient gradientUnits="userSpaceOnUse" y2="413.58" x2="69.93" y1="523.99" x1="-.05" id="bc">
              <stop stop-color="#b8b7b7" offset="0"></stop>
              <stop stop-color="#d1d0d0" offset=".4"></stop>
              <stop stop-color="#fff" offset="1"></stop>
            </linearGradient>
            <linearGradient xlink:href="#bc" y2="466.09" x2="44.69" y1="505.35" x1="19.81" id="bd"></linearGradient>
            <radialGradient gradientUnits="userSpaceOnUse"
              gradientTransform="translate(261.63 273.14) rotate(125.14) scale(1 .88)" r="39.33" fy="217.89" fx="66.91"
              cy="217.89" cx="66.91" id="be">
            ...
            <linearGradient gradientUnits="userSpaceOnUse" y2="380.41" x2="126.25" y1="374.95" x1="129.28" id="bf">
              <stop stop-color="#fff" offset="0"></stop>
            ...
            <linearGradient gradientUnits="userSpaceOnUse" y2="440.89" x2="97.61" y1="437.49" x1="65.52" id="bg">
              <stop stop-color="#e8e8e8" offset="0"></stop>
            ...
            <linearGradient gradientUnits="userSpaceOnUse" y2="198.33" x2="136.86" y1="176.68" x1="77.37" id="bh">
            ...
            <linearGradient gradientUnits="userSpaceOnUse" y2="443.62" x2="81.11" y1="411.38" x1="79.7" id="bi">
            ...
            <linearGradient gradientUnits="userSpaceOnUse" gradientTransform="translate(-8.09 4.61) rotate(-2.79)"
              y2="170.77" x2="91.3" y1="162.16" x1="94.5" id="bj">
              <stop stop-color="#3f3f3f" offset=".13"></stop>
              <stop stop-color="#090909" offset="1"></stop>
            </linearGradient>
            <linearGradient xlink:href="#bj" gradientTransform="translate(31.76 -5.44) rotate(5.03) scale(.81 1)"
              y2="171.47" x2="86.96" y1="164.53" x1="89.54" id="bk"></linearGradient>
            <linearGradient xlink:href="#bj" gradientTransform="translate(-16.29 4.64) rotate(-2.49) scale(1.1 1)"
              y2="172.9" x2="94.31" y1="166.02" x1="96.87" id="bl"></linearGradient>
          </defs>
          <g id="c">
            <g>
            ...
            <g id="u">
              ...
              <path style="fill:url(#x);"
                d="M102.66,117.5s6,24,45.5,24,46-24,46-24l-.5,74s-12.5,15-45,15-46-15-46-15V117.5Z"></path>
            ...
            <g>
              ...
              <path style="fill:url(#au);"
                d="M106.84,454.41l3.26,19.01s-2.53,3.14-13.76,1.82-12.99-5.17-12.99-5.17l8.31-16.95,15.18,1.3Z"></path>
              <path style="fill:url(#av);"
                d="M76.16,454.7l-1.28,20.7s-3.42,2.66-14.85-1.5-12.31-8.62-12.31-8.62l12.88-15.68,15.56,5.11Z"></path>
              <path style="fill:url(#aw);"
                d="M81.49,464.75l.92,10.27s-1.48,1.56-7.41,.37c-5.93-1.19-6.7-3.32-6.7-3.32l5.16-8.67,8.03,1.35Z">
              </path>
              <path style="fill:url(#ax); filter:url(#ay); stroke:#2b2b2b; stroke-miterlimit:10; stroke-width:2px;"
              ...
              <line style="fill:none; stroke:#2b2b2b; stroke-miterlimit:10; stroke-width:.75px;" y2="426.74" x2="126.39"
                y1="448.76" x1="183.2"></line>
              <line style="fill:none; stroke:#2b2b2b; stroke-miterlimit:10; stroke-width:.75px;" y2="342.41" x2="17.4"
                y1="368.13" x1="51.09"></line><text style="fill:#333; font-size:12.27px;"
                ...
                <tspan
                  ...
                  y="0" x="11.3">V</tspan>
                <tspan style="font-family:Bahnschrift, Bahnschrift; font-variation-settings:'wght' 400, 'wdth' 100;"
                  y="0" x="18.56">E</tspan>
                <tspan
              ...
              <line style="fill:#fff; stroke:#2b2b2b; stroke-miterlimit:10; stroke-width:.5px;" y2="426.74" x2="126.39"
                y1="432.01" x1="124.42"></line>
              <path style="fill:url(#bj);" d="M91.12,170.73c2.47,.54,5.71-8.54,3.35-8.72s-5.82,8.18-3.35,8.72Z"></path>
              <path style="fill:url(#bk);" d="M86.98,171.58c1.41,.66,4.25-6.41,2.87-6.77s-4.28,6.1-2.87,6.77Z"></path>
              <path style="fill:url(#bl);" d="M94.44,172.88c2.08,.44,4.88-6.87,2.88-7.01s-4.96,6.57-2.88,7.01Z"></path>
            </g>
          </g>
        </svg>
      </div>
    ...
    <el-table :data="tableData" style="width: 50%" :row-class-name="tableRowClassName"
      ...
      <el-table-column prop="person_id" label="person_id" width="150" />
      <el-table-column prop="total_duration" label="锻炼时长" width="150" />
      <el-table-column prop="count" label="个数" width="150" />
      <el-table-column prop="score" label="得分" width="150" />
      <el-table-column prop="v" label="个/分钟" width="150" />
    ...
    <el-button type="danger" @click="clearData">Clear All Data</el-button>
  </div>
</template>
...
const fetchData = async () => {
  try {
    const response = await axios.get('http://127.0.0.1:5000/data'); // 替换为你的API端点
    tableData.value = response.data; // 假设返回的数据是一个数组
  } catch (error) {
...
const updateRow = async (row) => {
  try {
    ...
    // 发送更新请求到后端
    await axios.put(`http://127.0.0.1:5000/data/${row.id}`, updatedData); // 替换为你的API端点
...
const clearData = async () => {
  try {
    await axios.delete('http://127.0.0.1:5000/data/clear'); // 替换为你的API端点
    await fetchData(); // 清除数据后重新获取数据
